...
const transparentBackgroundColorButton = wrapper.querySelector("[data-action=transparent-background-color]");
...
transparentBackgroundColorButton.addEventListener('click', () => {
